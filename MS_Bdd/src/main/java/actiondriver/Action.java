...
public class Action extends BaseClass implements ActionInterface{
	...
	public void highLight(WebDriver driver, WebElement ele) {
		...
		JavascriptExecutor js = (JavascriptExecutor)driver;   
		js.executeScript("arguments[0].setAttribute('style','background: green; border: 2px solid red;');", ele); 
		
	}

	@Override
	public String randomStringGenerator(WebDriver driver, int length) {
		// TODO Auto-generated method stub
